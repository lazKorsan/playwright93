package webTest.TestAutamationPractice.TestNG;
...
public class formDoldurmaTesti {
    ...
    public static void formDoldurma(Page page) throws ParseException {
     ...
     // BrowserUtils.setUpFullScreen("chrome", "https://testautomationpractice.blogspot.com/");
    ...
    @Test
    public void testFormDoldurma() throws ParseException {
